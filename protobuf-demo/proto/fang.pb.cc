...
void protobuf_AssignDesc_fang_2eproto() {
  ...
  static const int AddressBook_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AddressBook, blist_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_fang_2eproto);
}
...
void protobuf_AddDesc_fang_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nfang.proto\022\004fang\"$\n\007Persion\022\014\n\004name\030\001 "
    "\002(\t\022\013\n\003age\030\002 \002(\005\"C\n\013AddressBook\022\024\n\005bList"
    "\030\002 \001(\010:\005false\022\036\n\007persion\030\001 \003(\0132\r.fang.Pe"
    "rsion", 125);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "fang.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_fang_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_fang_2eproto {
  StaticDescriptorInitializer_fang_2eproto() {
    protobuf_AddDesc_fang_2eproto();
  }
} static_descriptor_initializer_fang_2eproto_;
...
const Persion& Persion::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_fang_2eproto();
...
#ifndef _MSC_VER
const int AddressBook::kBListFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_bList;
        break;
      }
...
void AddressBook::SerializeWithCachedSizes(
  ...
  // optional bool bList = 2 [default = false];
  if (has_blist()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(2, this->blist(), output);
  }
...
::google::protobuf::uint8* AddressBook::SerializeWithCachedSizesToArray(
  ...
  // optional bool bList = 2 [default = false];
  if (has_blist()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(2, this->blist(), target);
  }
